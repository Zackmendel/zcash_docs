---
title: "Debian Binary Packages Setup"
category: "Installation"
id: "source/rtd_pages/install_debian_bin_packages"
---
...
The Electric Coin Company operates a package repository for 64-bit
Debian-based distributions. If you'd like to try out the binary
packages, you can set it up on your system and install Zcash from there.
...
Get the new key directly from the [z.cash
site](https://apt.z.cash/zcash.asc):
...
For any other signing key issues see `updating_signing_keys`
...
4.9 or later. First check which version you have using `g++ --version`;
...
<span class="title-ref">apt-transport-tor</span> package, at the address
zcaptnv5ljsxpnjt.onion. Use the following pattern in your sources.list
file: `deb [arch=amd64] tor+http://zcaptnv5ljsxpnjt.onion/ stretch main`

## Updating Signing Keys

If your Debian binary package isn't updating due to an error with the
public key, you can resolve the problem by updating to the new key.
